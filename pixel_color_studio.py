...
Pixel Color Studio
===================
A Tkinter + OpenCV desktop application for transforming an image through
its pixel colors:

  - Click anywhere on the image to pick a color (shows RGB / HEX)
  - Color Replace: swap the picked color (within a tolerance) for a new
    color you choose, everywhere it appears
  - Posterize: reduce the image to N color levels (flat "poster" look)
  - Pixelate: downsample into large blocky "pixel art" squares

Visual theme: flat dark navy / purple palette (no gradients or glow --
those need a browser; this approximates the look with solid flat colors).

Dependencies:
    pip install opencv-python pillow numpy

Run:
    python pixel_color_studio.py
"""
